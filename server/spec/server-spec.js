...
describe('Persistent Node Chat Server', function() {
  ...
  it('Should output all messages from the DB', function(done) {
    ...
    // them up to you. */
    dbConnection.query(`insert into users (username, createdAt, updatedAt) VALUES ('some_user', '1000-01-01 00:00:00', '1000-01-01 00:00:00')`, function(error, results) {
      if (error) {
  ...
  it('Should keep track of how many messages there are on the DB', function(done) {
    ...
    dbConnection.query(`insert into users (username, createdAt, updatedAt) VALUES ('some_user2', '1000-01-01 00:00:00', '1000-01-01 00:00:00')`, function(error, results) {
      if (error) {
